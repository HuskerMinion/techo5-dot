...
from analyze import CENTER, MICS, RATE, bandpass, db, frame_power, load
...
cen = cancel(ref, mics[CENTER], fit(ref[:lead], mics[CENTER, :lead]))
...
for name, sig, q in [("center + AEC", cen, quiet[CENTER]), ("7 AECs, averaged", seven, quiet.mean(0)), ("1 AEC on the 7-mic average", one, quiet.mean(0))]:
